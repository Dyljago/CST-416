...
import com.dylanjohnson.contactsapp.classes.ContactRemove
...
@Composable
fun RemoveContactScreen(viewModel: ContactViewModelInterface, navController: NavHostController) {
                        ...
                        ContactRemove(
                            viewModel, contact = contacts[index], {
                                ...
                                var changedContact = when (contacts[it]) {
                                    ...
                                    is BusinessModel -> (contacts[it] as BusinessModel).copy(
                                        isExpanded = !contacts[it].getExpanded()
                                    )
