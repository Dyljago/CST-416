...
class BusinessModel : ContactModel {
    ...
    constructor(@JsonProperty("id")id: Int, @JsonProperty("name")name: String, @JsonProperty("email")email: String,
                ...
                @JsonProperty("webURL")webURL: String, @JsonProperty("myOpinionRating")myOpinionRating: Float,
                @JsonProperty("daysOpen")daysOpen: BooleanArray
    ...
    fun setAllDaysOpen(newVal: BooleanArray) {
        _daysOpen = newVal
    }
    ...
    fun businessCopy(contact: BusinessModel): BusinessModel {
        return BusinessModel(contact.getId(), contact.getName(), contact.getEmail(),
            contact.getPhoneNum(), contact.getAddress(), contact.getExpanded(),
            contact.getWebURL(), contact.getMyOpinionRating(),
            contact.getDaysOpen())
    }
}
