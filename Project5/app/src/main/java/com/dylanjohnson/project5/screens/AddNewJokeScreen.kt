...
@Composable
public fun AddJokeScreen(navController: NavHostController, jokes: MutableList<JokeModel>) {
    ...
    Box(
        ...
        Column(
            ...
            Button(
                onClick = {
                    val newJoke = JokeModel(jokes[jokes.size-1].id + 1, jokeQuestion, jokeAnswer, true)
                    jokes.add(newJoke)
