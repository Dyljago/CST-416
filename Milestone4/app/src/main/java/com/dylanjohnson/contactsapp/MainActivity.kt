...
import com.dylanjohnson.contactsapp.data.JokesViewModelInterface
import com.dylanjohnson.contactsapp.data.ViewModelJSON
...
fun MainScreen() {
    ...
    val screens = listOf(
        ...
        , ScreenInfo(
            ...
            composable = { SettingsScreen(backgroundImage, viewModel) }
        )
    )
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun SettingsScreen(backgroundImage: Int, viewModel: JokesViewModelInterface) {
            ...
            LazyColumn() {
                ...
                item {
                    ...
                    Row(
                        ...
                        }, shape = CircleShape, modifier = Modifier.size(40.dp), contentPadding = PaddingValues(2.dp)) {
                            Icon(
